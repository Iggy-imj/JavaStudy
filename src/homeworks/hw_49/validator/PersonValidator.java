...
public class PersonValidator {
    ...
    public static void validateEmail(String email) throws EmailValidateException {
        ...
        // throw - ключевое слово используется для явного выброса исключения (создания обьекта исключения)
        ...
        if (indexAt == 0) throw new EmailValidateException("@ should be nit first");
