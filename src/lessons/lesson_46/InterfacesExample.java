...
public class InterfacesExample {
    public static void main(String[] args) {
        ...
        // Consumer<T> - выполянет операцию над обьектом типа Т при этом не возвращает никакого результата
        // void accept(T t)
        ...
        // Predicate<T> - проверка обьекта на соответствие условию
        // boolean test(T t)
        // and()
        ...
        List<Integer> list = new ArrayList<>(List.of(-1,3,-4,0,34,-145,11,45,10,-50,12,36,4));
        ...
        res = filterListByPredicate(list, val -> val % 2 != 1);
        System.out.println("filterListByPredicate(list, val -> val % 2 != 1): " + res);
        ...
        System.out.println("\n===== Function =======\n");
        // Function<T, R> - производит операцию над типом Т и возвращает результат типа R
        // R apply(T t)
    ...
    // Метод должен возвращать список обьектов, удовлетворяющий условие
