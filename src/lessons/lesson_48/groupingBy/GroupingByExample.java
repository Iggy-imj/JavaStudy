package lessons.lesson_48.groupingBy;
...
public class GroupingByExample {
    ...
    группирует элементы по ключу который будет получит с помощью функции классификатор
    ...
    private static void task3() {
        List<Employee> employees = new ArrayList<>(
                List.of(
                        ...
                        new Employee("Olivia", 3500, 25, "manager", "Menagement"),
                        new Employee("Sebastian", 2500, 28, "chef", "Menagement"),
                        new Employee("Hanna", 2000, 35, "chef", "Cleaning"),
                        new Employee("Max", 1300, 34, "cleaner", "Cleaning"),
        ...
        map.forEach((department, employeesList) -> System.out.println(department + ": " + employeesList));
        ...
        // Колличество сотрудников по отделам
